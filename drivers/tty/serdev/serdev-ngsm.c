...
static int serdev_ngsm_set_config(struct device *dev)
{
	...
	err = gsm_serdev_set_config(gsd, ddata->cfg->gsm);
	if (err)
		return err;
...
static const struct gsm_config adaption1 = {
	...
	.t1 = 10,		/* open/close timer, default 100ms */
	.t2 = 34,		/* control response timeout, default 333ms */
...
static const struct gsm_config motmdm = {
	.i = 1,			/* 1 = UIH, 2 = UI */
	.initiator = 1,
	.encapsulation = 0,	/* basic mode */
	.adaption = 1,
	.mru = 1024,		/* from android TS 27010 driver */
	.mtu = 1024,		/* from android TS 27010 driver */
	.t1 = 50,		/* open/close timer, 500ms */
	.t2 = 50,		/* control response timeout, 500ms */
	.n2 = 10,		/* retransmissions, default 10 */
};

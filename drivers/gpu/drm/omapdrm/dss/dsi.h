...
#define DSI_TE_HSYNC_WIDTH(n)		DSI_REG(DSI_PROTO, 0x00A0 + (0xC * n))
#define DSI_TE_VSYNC_WIDTH(n)		DSI_REG(DSI_PROTO, 0x00A4 + (0xC * n))
#define DSI_TE_HSYNC_NUMBER(n)		DSI_REG(DSI_PROTO, 0x00A8 + (0xC * n))
